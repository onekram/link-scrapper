...
class MessageUtilTest {
    ...
    @Test
    void testNotEmpty() {
        String result = MessageUtil.linkMessage(TestUtil.generateLinkResponse("url", List.of("tag1", "tag2"), List.of("filter1", "filter2")));
    ...
    @Test
    void testNoTags() {
        String result = MessageUtil.linkMessage(TestUtil.generateLinkResponse("url", Collections.emptyList(), List.of("filter1", "filter2")));
    ...
    @Test
    void testNoFilters() {
        String result = MessageUtil.linkMessage(TestUtil.generateLinkResponse("url", List.of("tag1", "tag2"), Collections.emptyList()));
        assertLines(2, result);
