...
class LinksControllerTest {
    ...
    void getLinksOk() throws Exception {
        ...
        when(linksRepository.getLink(42L)).thenReturn(new LinkRecord(42L, new URI("https://dot.com"), Collections.emptyList(), Collections.emptyList(), LinkType.GITHUB));
        when(linksRepository.getLink(43L)).thenReturn(new LinkRecord(42L, new URI("https://another.com"), Collections.emptyList(), Collections.emptyList(), LinkType.STACK_OVERFLOW));
    ...
    void addLinkOk() throws Exception {
        ...
        when(linksRepository.getLink(42L)).thenReturn(new LinkRecord(42L, new URI("https://dot.com"), Collections.emptyList(), Collections.emptyList(), LinkType.GITHUB));
        when(linksRepository.getLink(43L)).thenReturn(new LinkRecord(42L, new URI("https://another.com"), Collections.emptyList(), Collections.emptyList(), LinkType.STACK_OVERFLOW));
        when(linksRepository.addLink(any())).thenReturn(new LinkRecord(123L, new URI("https://third.com"), Collections.emptyList(), Collections.emptyList(), null));
        mockMvc.perform(post("/links")
                .contentType(MediaType.APPLICATION_JSON)
                .header("Tg-Chat-Id", 1L)
                .content(objectMapper.writeValueAsString(new AddLinkRequest("https://third.com", Collections.emptyList(), Collections.emptyList()))))
            .andExpect(status().isOk())
