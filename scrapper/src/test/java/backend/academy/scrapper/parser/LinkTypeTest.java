...
class LinkTypeTest {
    ...
    @Test
    void getType() {
        assertEquals(LinkType.GITHUB, LinkType.getType("https://github.com/onekram/game").get());
        assertEquals(LinkType.GITHUB, LinkType.getType("https://github.com/who/repo").get());
        assertEquals(LinkType.GITHUB, LinkType.getType("http://github.com/who/repo").get());
        assertEquals(null,  LinkType.getType("https://githsdfsub.com/who/repo").orElse(null));
    }
